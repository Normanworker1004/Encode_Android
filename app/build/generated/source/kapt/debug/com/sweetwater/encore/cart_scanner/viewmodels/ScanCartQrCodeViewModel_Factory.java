...
public final class ScanCartQrCodeViewModel_Factory implements Factory<ScanCartQrCodeViewModel> {
  ...
  public ScanCartQrCodeViewModel_Factory(Provider<Context> contextProvider,
  ...
  @Override
  public ScanCartQrCodeViewModel get() {
  ...
  public static ScanCartQrCodeViewModel_Factory create(Provider<Context> contextProvider,
      Provider<ICartScannerService> cartScannerServiceProvider,
      Provider<IBarcodeScanner> barcodeScannerProvider,
      Provider<IConnectivityService> connectivityServiceProvider,
      Provider<ISoundService> soundServiceProvider,
      Provider<IVibratorService> vibratorServiceProvider,
      Provider<CoroutineDispatcher> ioDispatcherProvider) {
    return new ScanCartQrCodeViewModel_Factory(contextProvider, cartScannerServiceProvider, barcodeScannerProvider, connectivityServiceProvider, soundServiceProvider, vibratorServiceProvider, ioDispatcherProvider);
  }

  public static ScanCartQrCodeViewModel newInstance(Context context,
    ...
    return new ScanCartQrCodeViewModel(context, cartScannerService, barcodeScanner, connectivityService, soundService, vibratorService, ioDispatcher);
  }
}
